...
module.exports = {
  siteMetadata: {
    title: `Diwakar Sharma Portfolio`,
    titleTemplate: `%s | Diwakar Sharma Portfolio`,
  ...
  plugins: [
    ...
    `gatsby-plugin-sharp`,
    {
      ...
      options: {
        name: `Diwakar Sharma Portfolio`,
        short_name: `Diwakar Sharma Portfolio`,
        start_url: `/`,
